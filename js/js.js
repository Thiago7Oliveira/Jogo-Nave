...
function start() { // Inicio da funcao start()
   ...
   function loop() {
      //chama mover fundo
      movefundo();
      //habilita o placar do jogo
      placar();
      //chama mover jogador
      movejogador();
      //chama inimigo randomico apache
      moveinimigo1();
      //chama mover inimigo 2 caminhao
      moveinimigo2();
      //move amigo personagem
      moveamigo();
      //chama funcao de colisao de objetos
      colisao();
      //chama teste de energia
      energia();
